...
TEST (toml, daemon_config_deserialize_defaults)
{
	...
	ASSERT_EQ (conf.node.rocksdb_config.block_cache_multiplier, defaults.node.rocksdb_config.block_cache_multiplier);
...
TEST (toml, daemon_config_deserialize_no_defaults)
{
	...
	ASSERT_NE (conf.node.rocksdb_config.block_cache_multiplier, defaults.node.rocksdb_config.block_cache_multiplier);
